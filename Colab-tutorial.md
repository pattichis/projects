...
## Populating your directory with your Google Colab files:
* New files: Use "New" to create new Google Colab files from scratch.
* From GitHub: Use "Download" to download Google Colab files to the Google Drive folder on your computer.
* From raw files on the internet: Use "Save Page As" to download library files (named library.py) to your directory.
  
## Debugging Google Colab files locally:
1. Inside Google Chrome, after you click on Google Drive, you can navigate to your directory and run Google Colab files locally.
2. Verify the location of your files by using "locate in drive".

After you are done, you can create a GitHub repo to upload everything as highlighted below.
